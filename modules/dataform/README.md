...
| <a name="input_bigquery_datasets"></a> [bigquery\_datasets](#input\_bigquery\_datasets) | List of BigQuery dataset IDs to be created in default app project | <pre>list(object({<br/>    dataset_id  = string<br/>    region      = optional(string, "EU")<br/>    description = optional(string, null)<br/>  }))</pre> | `[]` | no |
